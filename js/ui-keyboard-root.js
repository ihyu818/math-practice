  ...
  render: (containerId, onPress) => {
    ...
    container.innerHTML = `
      ...
      <div class="col-span-1 flex flex-col gap-2">
        ...
        <div onclick="window.gamePress('*')" 
             class="flex-1 flex items-center justify-center bg-amber-50 text-amber-600 border border-amber-100 rounded-xl shadow-sm active:scale-95 cursor-pointer select-none">
             <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                <path d="M3 12l3 9 4-15h11" />
             </svg>
        </div>
      </div>
    `;
